...
The following represent some implementation considerations regarding the capabilities depicted for Tier 1 in Figure 4.1.
...
[width=728]
.Standards in Tier 2, for standard descriptions see_ https://drive.google.com/file/d/1DAb4QinqlEecqFzvtqi7JpnX7zzpdZJM/view?usp=sharing[_Appendix 1_]
|===
...
Figure 4.4 depicts potential "foundation" geospatial information themes shared between and among many organizations and constituents.

.Example: Foundation geospatial information layers (Source:_ http://link.fsdf.org.au/[_ANZLIC_]_)
image::images/figure4.4.png[]

Geospatial information can be designed for delivery across multiple platforms and can be discovered, described, and accessed via web-based catalogs. Essential geospatial information themes are made available as "foundation" or "framework" data. These foundation themes have known accuracy and currency so that other geospatial data can be consistently integrated. http://ggim.un.org/UNGGIM-wg2/[UN-G] http://ggim.un.org/UNGGIM-wg2/[GIM] http://ggim.un.org/UNGGIM-wg2/[Working Group on Global Fundamental Geospatial Data Themes] have developed 14 foundational data themes in support of the UN-GGIM program of work.
...
* https://www.ogc.org/standards/wps[_OGC Web Processing Service (WPS)_] – provides rules for standardizing how inputs and outputs (requests and responses) for geospatial processing services, such as generating a polygon overlay. http://www.opengeospatial.org/standards/wps[] http://www.opengeospatial.org/standards/wps[The standard also defines how a client can request the execution of a process, and how the output from the process is handled. It defines an interface that facilitates the publishing of geospatial processes and the clients' discovery of and binding to those processes and clients' discovery and binding to those processes, thereby establishing "syntactic interoperability".]The data required by the WPS can be delivered across a network or they can be available at the server. Processes are predefined by the administrator and users can only provide their individual input parameters. http://www.opengeospatial.org/standards/wps[A particular use case for WPS is making a Web service out of code that originally was not Web-ready.] http://www.opengeospatial.org/standards/wps[] http://www.opengeospatial.org/standards/wp[http://www.opengeospatial.org/standards/wp]s.
...
[width=809]
.Standards in Tier 3, for standard descriptions see_ https://drive.google.com/file/d/1DAb4QinqlEecqFzvtqi7JpnX7zzpdZJM/view?usp=sharing[_Appendix 1_]
|===
...
There could be several different views on the trends driving new areas of standards development or new applications of existing standards. One of many such views, which combine the UN-GGIM and OGC's trends, is presented below (Fig. 4.7):

.Trends driving New Areas of Standards Development image::
image::images/figure4.7.png[]
...
[width=837]
.Standards in Tier 4 (for standard descriptions see_ https://drive.google.com/file/d/1DAb4QinqlEecqFzvtqi7JpnX7zzpdZJM/view?usp=sharing[_Appendix 1_]_)
|===
